...
<button class="btn" type="button" onclick="addToCart('beatles_1'); <?php $_SESSION['beatles_1'] = $_SESSION['beatles_1'] + 1; echo 'Beatles 1 #: ' . $_SESSION['beatles_1']; ?>">Add to cart</button>
<br />
