...
create table notes (
    ...
    text			text							not null,
    fk_conference_title	text	references conference_talks(title)	not null,
...
insert into notes (text, fk_conference_title, fk_user)
	values ('My note', 'Guidance from the Holy Ghost', 'Reed Harston');

insert into notes (text, fk_conference_title, fk_user)
	values ('My note2', 'Beware of Pride', 'Reed Harston');

insert into notes(text, fk_conference_title, fk_user)
	values ('My note3', 'Beware of Pride', 'Reed Harston');

insert into notes(text, fk_conference_title, fk_user)
	values ('My note4', 'The Power of the Book of Mormon', 'Timothy Bohman');

insert into notes(text, fk_conference_title, fk_user)
	values ('My note5', 'Guidance from the Holy Ghost', 'Timothy Bohman');

insert into notes(text, fk_conference_title, fk_user)
	values ('My note6', 'Guidance from the Holy Ghost', 'Timothy Bohman');
